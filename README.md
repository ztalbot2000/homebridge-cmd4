...
### <p style="text-align: right; font-size: 23px; font-weight: 1000;">[![][dl]][npm] [![][license]][npm] [![][v]][npm]</p>
### <p style="text-align: left; font-size: 23px; font-weight: 1000;">Homebridge Cmd4</p>
