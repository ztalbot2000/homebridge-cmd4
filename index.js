...
class Cmd4Platform
{
   ...
   processPlatformAccessoriesConfig( platformAccessoriesConfig, api )
   {
      ...
      platformAccessoriesConfig && platformAccessoriesConfig.forEach( ( config ) =>
      {
         ...
         let displayName = getAccessoryDisplayName( config );
         let name = getAccessoryName( config );
         ...
         let UUID = getAccessoryUUID( config, API.hap.uuid );
         ...
         } else
         {
            ...
            let category = API.hap.Categories[ String( config.category ).toUpperCase( ) ];
   ...
   createServicesForPlatformAccessoryAndItsChildren( cmd4PlatformAccessory )
   {
      ...
      if ( cmd4PlatformAccessory.model )
      {
         ...
         cmd4PlatformAccessory.platform.getService( cmd4PlatformAccessory.platform.Service.AccessoryInformation )
            .setCharacteristic( API.hap.Characteristic.Model, cmd4PlatformAccessory.model );
      }
      ...
      if ( cmd4PlatformAccessory.manufacturer )
      {
         ...
         cmd4PlatformAccessory.platform.getService( cmd4PlatformAccessory.platform.Service.AccessoryInformation )
            .setCharacteristic( API.hap.Characteristic.Manufacturer, cmd4PlatformAccessory.manufacturer );
      }
      ...
      if ( cmd4PlatformAccessory.serialNumber )
      {
         ...
         cmd4PlatformAccessory.platform.getService( cmd4PlatformAccessory.platform.Service.AccessoryInformation )
            .setCharacteristic( API.hap.Characteristic.SerialNumber, cmd4PlatformAccessory.serialNumber );
      }
      ...
      if ( cmd4PlatformAccessory.firmwareRevision )
      {
         ...
         cmd4PlatformAccessory.platform.getService( cmd4PlatformAccessory.platform.Service.AccessoryInformation )
            .setCharacteristic( API.hap.Characteristic.FirmwareRevision, cmd4PlatformAccessory.firmwareRevision );
      }
