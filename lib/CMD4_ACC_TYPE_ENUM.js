   ...
   init: function (Characteristic)
   {
      ...
      CMD4_ACC_TYPE_ENUM.properties =
      {
         ...
         3:   { type: "Active",
                ...
                verifyCharacteristic: Characteristic.Active,
                props:
         ...
         49:  { type: "CurrentTransport",   // HomeKit.d.ts
                ...
                UUID: "0000021E-0000-1000-8000-0000022B",
                verifyCharacteristic: null,
                props: {format: Characteristic.Formats.BOOL,
                        perms: [Characteristic.Perms.READ
                               ]
         ...
         87:  { type: "LockTargetState",
                ...
                verifyCharacteristic: Characteristic.LockCurrentState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         144: { type: "SecuritySystemTargetState",
                ...
                verifyCharacteristic: Characteristic.SecuritySystemCurrentState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 3,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         155: { type: "SignalToNoiseRatio",  // HomeKit
                ...
                UUID: "0000021E-0000-1000-8000-00000241",
                verifyCharacteristic: null,
                props: {format: Characteristic.Formats.INT,
                         perms: [Characteristic.Perms.PAIRED_READ
                                ]
         ...
         159: { type: "SleepInterval",  // HomeKitTypes.d.ts
                ...
                UUID: "0000021E-0000-1000-8000-0000023A",
                verifyCharacteristic: null,
                props: {format: Characteristic.Formats.UINT32,
                        minValue: 0,
                        minStep:  1,
         ...
         181: { type: "TargetAirPurifierState",
                ...
                verifyCharacteristic: Characteristic.CurrentAirPurifierState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         182: { type: "TargetAirQuality",
                ...
                verifyCharacteristic: Characteristic.AirQuality,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 2,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         185: { type: "TargetDoorState",
                ...
                verifyCharacteristic: Characteristic.CurrentDoorState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         186: { type: "TargetFanState",
                ...
                verifyCharacteristic: Characteristic.CurrentFanState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         187: { type: "TargetHeaterCoolerState",
                ...
                verifyCharacteristic: Characteristic.CurrentHeaterCoolerState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 2,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         188: { type: "TargetHeatingCoolingState",
                ...
                verifyCharacteristic: Characteristic.CurrentHeatingCoolingState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 3,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         189: { type: "TargetHorizontalTiltAngle",
                ...
                verifyCharacteristic: Characteristic.CurrentHorizontalTiltAngle,
                props: {format: Characteristic.Formats.INT,
                        unit: Characteristic.Units.ARC_DEGREE,
                        maxValue: 90,
                        minValue: -90,
         ...
         190: { type: "TargetHumidifierDehumidifierState",
                ...
                verifyCharacteristic: Characteristic.CurrentHumidifierDehumidifierState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 2,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         191: { type: "TargetMediaState",   // HomeKitTypes-Television
                ...
                verifyCharacteristic: Characteristic.CurrentMediaState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 2,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         192: { type: "TargetPosition",
                ...
                verifyCharacteristic: Characteristic.CurrentPosition,
                props: {format: Characteristic.Formats.UINT8,
                        unit: Characteristic.Units.PERCENTAGE,
                        maxValue: 100,
                        minValue: 0,
         ...
         193: { type: "TargetRelativeHumidity",
                ...
                verifyCharacteristic: Characteristic.CurrentRelativeHumidity,
                props: {format: Characteristic.Formats.FLOAT,
                        unit: Characteristic.Units.PERCENTAGE,
                        maxValue: 100,
                        minValue: 0,
         ...
         194: { type: "TargetSlatState",
                ...
                verifyCharacteristic: Characteristic.CurrentSlatState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
         ...
         195: { type: "TargetTemperature",
                ...
                verifyCharacteristic: Characteristic.CurrentTemperature,
                props: {format: Characteristic.Formats.FLOAT,
                        unit: Characteristic.Units.CELSIUS,
                        maxValue: 38,
                        minValue: 10,
         ...
         196: { type: "TargetTiltAngle",
                ...
                verifyCharacteristic: Characteristic.CurrentTiltAngle,
                props: {format: Characteristic.Formats.INT,
                        unit:   Characteristic.Units.ARC_DEGREE,
                        maxValue:  90,
                        minValue: -90,
         ...
         197: { type: "TargetVerticalTiltAngle",
                ...
                verifyCharacteristic: Characteristic.CurrentVerticalTiltAngle,
                props: {format: Characteristic.Formats.INT,
                        unit: Characteristic.Units.ARC_DEGREE,
                        maxValue: 90,
                        minValue: -90,
         ...
         198: { type: "TargetVisibilityState",   // HomeKittypes-Television
                ...
                verifyCharacteristic: Characteristic.CurrentVisibilityState,
                props: {format: Characteristic.Formats.UINT8,
                        maxValue: 1,
                        minValue: 0,
                        perms: [Characteristic.Perms.READ,
