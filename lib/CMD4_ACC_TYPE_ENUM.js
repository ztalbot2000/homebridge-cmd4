...
CMD4_ACC_TYPE_ENUM.properties =
{
   ...
   0:   { type: "AccessControlLevel",
          ...
          props: {format: clonedCharacteristic.Formats.UINT16,
                  allowedWordCount: 1,
                  maxValue: 2,
                  minValue: 0,
                  minStep: 1,
                  perms: [clonedCharacteristic.Perms.NOTIFY,
                          clonedCharacteristic.Perms.PAIRED_READ,
                          clonedCharacteristic.Perms.PAIRED_WRITE
                         ]
                 },
          validValues: {}
        },
   1:   { type: "AccessoryFlags",
          ...
          relatedTargetAccTypeEnumIndex: null,
          stringConversionFunction: function ( str ){ return stringToInt( str ); },
          props: {format: clonedCharacteristic.Formats.UINT32,
                  allowedWordCount: 1,
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.NOTIFY
                         ]
                 },
          validValues: {}
        },
   2:   { type: "AccessoryIdentifier",   // HomeKitTypes-Bridge
          ...
          props: {format: clonedCharacteristic.Formats.STRING,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.READ
                         ]
                 },
   ...
   3:   { type: "Active",
          ...
          stringConversionFunction: function ( str ){ return stringToInt( str ); },
          props: {format: clonedCharacteristic.Formats.UINT8,
                  allowedWordCount: 1,
                  maxValue: 1,
                  minValue: 0,
                  minStep: 1,
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.WRITE,
                          clonedCharacteristic.Perms.NOTIFY
                         ]
             },
   ...
   6:   { type: "AdministratorOnlyAccess",
          ...
          props: {format: clonedCharacteristic.Formats.BOOL,
                  allowedWordCount: 1,
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.WRITE,
                          clonedCharacteristic.Perms.NOTIFY
   ...
   7:   { type: "AirParticulateDensity",
          ...
          props: {format: clonedCharacteristic.Formats.FLOAT,
                  allowedWordCount: 1,
                  maxValue: 1000,
                  minValue: 0,
                  perms: [clonedCharacteristic.Perms.READ,
   ...
   10:  { type: "AppMatchingIdentifier",
          ...
          props: {format: clonedCharacteristic.Formats.TLV8,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.READ
                         ]
                 },
   ...
   12:  { type: "BatteryLevel",
          ...
          props: {format: clonedCharacteristic.Formats.UINT8,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.PERCENTAGE,
                  maxValue: 100,
                  minValue: 0,
                  minStep: 1,
                  perms: [clonedCharacteristic.Perms.READ,
   ...
   13:  { type: "Brightness",
          ...
          relatedTargetAccTypeEnumIndex: null,
          stringConversionFunction: function ( str ){ return stringToInt( str ); },
          props: {format: clonedCharacteristic.Formats.INT,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.PERCENTAGE,
                  maxValue: 100,
                  minValue: 0,
   ...
   14:  { type: "ButtonEvent",
          ...
          props: {format: clonedCharacteristic.Formats.TLV8,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.PAIRED_READ,
                          clonedCharacteristic.Perms.NOTIFY
                         ]
                 },
          validValues: {}
   ...
   17:  { type: "CameraOperatingModeIndicator",
          ...
          props: {format: clonedCharacteristic.Formats.BOOL,
                  ...
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.WRITE,
                          clonedCharacteristic.Perms.NOTIFY,
                          clonedCharacteristic.Perms.TIMED_WRITE
                         ]
                 },
          validValues:
                 { "DISABLE": 0,
   ...
   25:  { type: "CharacteristicValueTransitionControl",    // HomeKit
          ...
          props: {format: clonedCharacteristic.Formats.TLV8,
                  ...
                  perms: [clonedCharacteristic.Perms.PAIRED_READ,
                          clonedCharacteristic.Perms.PAIRED_WRITE,
                          clonedCharacteristic.Perms.WRITE_RESPONSE
                         ]
                 },
          validValues: {}
        },
   ...
   29:  { type: "ConfigureBridgedAccessory",    // HomeKitTypes-Bridge
          ...
          props: {format: clonedCharacteristic.Formats.TLV8,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.WRITE
                         ]
                 },
          validValues: {}
        },
   ...
   33:  { type: "CoolingThresholdTemperature",
          ...
          props: {format: clonedCharacteristic.Formats.FLOAT,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.CELSIUS,
                  maxValue: 35,
                  minValue: 10,
                  minStep: 0.1,
                  perms: [clonedCharacteristic.Perms.READ,
   ...
   35:  { type: "CurrentAmbientLightLevel",
          ...
          props: {format: clonedCharacteristic.Formats.FLOAT,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.LUX,
                  maxValue: 100000,
                  minValue: 0.0001,
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.NOTIFY
   ...
   40:  { type: "CurrentHorizontalTiltAngle",
          ...
          props: {format: clonedCharacteristic.Formats.INT,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.ARC_DEGREE,
                  maxValue: 90,
                  minValue: -90,
                  minStep: 1,
                  perms: [clonedCharacteristic.Perms.READ,
   ...
   85:  { type: "LockManagementAutoSecurityTimeout",
          ...
          props: {format: clonedCharacteristic.Formats.UINT32,
                  allowedWordCount: 1,
                  unit: clonedCharacteristic.Units.SECONDS,
                  perms: [clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.WRITE,
                          clonedCharacteristic.Perms.NOTIFY
                         ]
   ...
   90:  { type: "MACTransmissionCounters",  // HomekitTypes.d.ts
          ...
          props: {format: clonedCharacteristic.Formats.DATA,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.PAIRED_READ
                         ]
                 },
   ...
   142: { type: "SecuritySystemAlarmType",  // Checked 03/17/21
   ...
   154: { type: "SetupTransferTransport",  // HomeKitTypes.d.ts
          ...
          props: {format: clonedCharacteristic.Formats.TLV8,
                  allowedWordCount: 0,
                  perms: [clonedCharacteristic.Perms.PAIRED_WRITE,
                          clonedCharacteristic.Perms.WRITE_RESPONSE
                         ]
                 },
          validValues: {}
   ...
   204: { type: "TunnelConnectionTimeout",   // HomeKitTypes-Bridge
          ...
          props: {format: clonedCharacteristic.Formats.INT,
                  allowedWordCount: 1,
                  perms: [clonedCharacteristic.Perms.WRITE,    // Reversed in HomeBridge
                          clonedCharacteristic.Perms.READ,
                          clonedCharacteristic.Perms.NOTIFY
                         ]
                 },
          validValues: {}
...
CMD4_ACC_TYPE_ENUM.add = function( api, type, description, props, validValues )
{
