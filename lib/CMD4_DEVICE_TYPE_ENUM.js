...
//let clonedCharacteristic = require( "./Cmd4_Characteristics" );
//let Categories = clonedCharacteristic.Categories;
let Characteristic = hapNodeJs.Characteristic;
let Categories = hapNodeJs.Categories;
...
CMD4_DEVICE_TYPE_ENUM.init = function( Service )
{
   // Fill in the properties of each device (Must be done at runtime)
   CMD4_DEVICE_TYPE_ENUM.properties[ 0 ].service = Service.AccessControl;
   CMD4_DEVICE_TYPE_ENUM.properties[ 1 ].service = Service.AccessoryRuntimeInformation;
   CMD4_DEVICE_TYPE_ENUM.properties[ 2 ].service = Service.AccessoryInformation;
   CMD4_DEVICE_TYPE_ENUM.properties[ 3 ].service = Service.AirPurifier;
   CMD4_DEVICE_TYPE_ENUM.properties[ 4 ].service = Service.AirQualitySensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 5 ].service = Service.BatteryService;
   CMD4_DEVICE_TYPE_ENUM.properties[ 6 ].service = Service.BridgeConfiguration;
   CMD4_DEVICE_TYPE_ENUM.properties[ 7 ].service = Service.BridgingState;
   CMD4_DEVICE_TYPE_ENUM.properties[ 8 ].service = Service.CameraEventRecordingManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 9 ].service = Service.CameraControl;
   CMD4_DEVICE_TYPE_ENUM.properties[ 10 ].service = Service.CameraRTPStreamManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 11 ].service = Service.CameraOperatingMode;
   CMD4_DEVICE_TYPE_ENUM.properties[ 12 ].service = Service.CarbonDioxideSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 13 ].service = Service.CarbonMonoxideSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 14 ].service = Service.ContactSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 15 ].service = Service.Diagnostics;
   CMD4_DEVICE_TYPE_ENUM.properties[ 16 ].service = Service.Door;
   CMD4_DEVICE_TYPE_ENUM.properties[ 17 ].service = Service.Doorbell;
   CMD4_DEVICE_TYPE_ENUM.properties[ 18 ].service = Service.Fan;
   CMD4_DEVICE_TYPE_ENUM.properties[ 19 ].service = Service.Fan;
   CMD4_DEVICE_TYPE_ENUM.properties[ 20 ].service = Service.Fanv2;
   CMD4_DEVICE_TYPE_ENUM.properties[ 21 ].service = Service.Faucet;
   CMD4_DEVICE_TYPE_ENUM.properties[ 22 ].service = Service.FilterMaintenance;
   CMD4_DEVICE_TYPE_ENUM.properties[ 23 ].service = Service.GarageDoorOpener;
   CMD4_DEVICE_TYPE_ENUM.properties[ 24 ].service = Service.HeaterCooler;
   CMD4_DEVICE_TYPE_ENUM.properties[ 25 ].service = Service.HumidifierDehumidifier;
   CMD4_DEVICE_TYPE_ENUM.properties[ 26 ].service = Service.HumiditySensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 27 ].service = Service.InputSource;
   CMD4_DEVICE_TYPE_ENUM.properties[ 28 ].service = Service.IrrigationSystem;
   CMD4_DEVICE_TYPE_ENUM.properties[ 29 ].service = Service.LeakSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 30 ].service = Service.LightSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 31 ].service = Service.Lightbulb;
   CMD4_DEVICE_TYPE_ENUM.properties[ 32 ].service = Service.LockManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 33 ].service = Service.LockMechanism;
   CMD4_DEVICE_TYPE_ENUM.properties[ 34 ].service = Service.Microphone;
   CMD4_DEVICE_TYPE_ENUM.properties[ 35 ].service = Service.MotionSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 36 ].service = Service.OccupancySensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 37 ].service = Service.Outlet;
   CMD4_DEVICE_TYPE_ENUM.properties[ 38 ].service = Service.Pairing;
   CMD4_DEVICE_TYPE_ENUM.properties[ 39 ].service = Service.PowerManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 40 ].service = Service.ProtocolInformation;
   CMD4_DEVICE_TYPE_ENUM.properties[ 41 ].service = Service.Relay;
   CMD4_DEVICE_TYPE_ENUM.properties[ 42 ].service = Service.SecuritySystem;
   CMD4_DEVICE_TYPE_ENUM.properties[ 43 ].service = Service.ServiceLabel;
   CMD4_DEVICE_TYPE_ENUM.properties[ 44 ].service = Service.Siri;
   CMD4_DEVICE_TYPE_ENUM.properties[ 45 ].service = Service.Slat;
   CMD4_DEVICE_TYPE_ENUM.properties[ 46 ].service = Service.SmartSpeaker;
   CMD4_DEVICE_TYPE_ENUM.properties[ 47 ].service = Service.SmokeSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 48 ].service = Service.Speaker;
   CMD4_DEVICE_TYPE_ENUM.properties[ 49 ].service = Service.StatefulProgrammableSwitch;
   CMD4_DEVICE_TYPE_ENUM.properties[ 50 ].service = Service.StatelessProgrammableSwitch;
   CMD4_DEVICE_TYPE_ENUM.properties[ 51 ].service = Service.Switch;
   CMD4_DEVICE_TYPE_ENUM.properties[ 52 ].service = Service.TargetControl;
   CMD4_DEVICE_TYPE_ENUM.properties[ 53 ].service = Service.TargetControlManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 54 ].service = Service.Television;
   CMD4_DEVICE_TYPE_ENUM.properties[ 55 ].service = Service.TelevisionSpeaker;
   CMD4_DEVICE_TYPE_ENUM.properties[ 56 ].service = Service.TemperatureSensor;
   CMD4_DEVICE_TYPE_ENUM.properties[ 57 ].service = Service.Thermostat;
   CMD4_DEVICE_TYPE_ENUM.properties[ 58 ].service = Service.TimeInformation;
   CMD4_DEVICE_TYPE_ENUM.properties[ 59 ].service = Service.TransferTransportManagement;
   CMD4_DEVICE_TYPE_ENUM.properties[ 60 ].service = Service.TunneledBTLEAccessoryService;
   CMD4_DEVICE_TYPE_ENUM.properties[ 61 ].service = Service.Valve;
   CMD4_DEVICE_TYPE_ENUM.properties[ 62 ].service = Service.WiFiRouter;
   CMD4_DEVICE_TYPE_ENUM.properties[ 63 ].service = Service.WiFiSatellite;
   CMD4_DEVICE_TYPE_ENUM.properties[ 64 ].service = Service.Window;
   CMD4_DEVICE_TYPE_ENUM.properties[ 65 ].service = Service.WindowCovering;

}

module.exports = CMD4_DEVICE_TYPE_ENUM;
