...
CMD4_DEVICE_TYPE_ENUM.init = function( hapNodeJs, Service )
{
   // Use the hapNodeJs passed in
   if ( hapNodeJs == undefined )
   {
      // Use the hapNodeJs from CMD4_ACC_TYPE_ENUM
      // Which may be discovered from the homebridge path
      if ( CMD4_ACC_TYPE_ENUM.hapNodeJs == undefined )
         throw new Error( `hapNodeJs not passed to CMD4_DEVICE_TYPE_ENUM` );

      hapNodeJs = CMD4_ACC_TYPE_ENUM.hapNodeJs;

      // this would be from homebridge-ui-utils server.js which is okay.
   ...
   // For Homebridge-ui-utils Server.js, which
   // does not use Service
   if ( Service == undefined )
      throw new Error( `Service not passed to CMD4_DEVICE_TYPE_ENUM` );
   ...
   CMD4_DEVICE_TYPE_ENUM.properties =
   {
      ...
      6:  { deviceName:'BridgeConfiguration', // Deprecated
            ...
            requiredCharacteristics:
               [ {type:           CMD4_ACC_TYPE_ENUM.ConfigureBridgedAccessoryStatus,
                 ...
                 {type:           CMD4_ACC_TYPE_ENUM.DiscoverBridgedAccessories,
                  defaultValue:   0,                              // Format: TLV8
                  relatedCurrentAccTypeEnumArray: [ ],
                  relatedTargetAccTypeEnumArray: [ ]
                 },
                 {type:           CMD4_ACC_TYPE_ENUM.DiscoveredBridgedAccessories,
                  defaultValue:   0,                              // Format: TLV8
                  relatedCurrentAccTypeEnumArray: [ ],
                  relatedTargetAccTypeEnumArray: [ ]
                 },
                 {type:           CMD4_ACC_TYPE_ENUM.ConfigureBridgedAccessory,
                  defaultValue:   0,                              // Format: TLV8
                  relatedCurrentAccTypeEnumArray: [ ],
                  relatedTargetAccTypeEnumArray: [ ]
                 }
